...
class CifarDit(nn.Module):
    def __init__(
        ...
        self.freqs_cis = CifarDit.precompute_freqs_cis(dim // n_heads, 4096)
    ...
    def forward_with_cfg(self, x, t, y, cfg_scale):
        ...
        model_out = self.forward(combined, t, y) # 这里的y是拼接过的y，前一半是y_cond，后一半是y_null
